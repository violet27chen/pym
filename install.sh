...
"
    ...
    echo "  pvm pin <ver>         - Pin version for directory"
    echo "  pvm venv <name>       - Create virtual environment"
    echo "  pvm pip install <pkg> - Install a package"
    echo "  pvm pip freeze        - List packages (requirements)"
    echo "  pvm export/import     - Export/import requirements"
    echo "  pvm lock/sync         - Lock/sync dependencies"
    echo "  pvm tree              - Show dependency tree"
    echo "  pvm tool install <p>  - Install a tool (like pipx)"
    echo "  pvm init/add/run      - Project management"
    echo "  pvm build/publish     - Build and publish package"
    echo "  pvm --help            - Show all commands"
    echo ""
