...
"@
    ...
    Write-ColorOutput "  pvm pin <ver>         - Pin version for directory" "White"
    ...
    Write-ColorOutput "  pvm pip freeze        - List packages (requirements)" "White"
    Write-ColorOutput "  pvm export/import     - Export/import requirements" "White"
    Write-ColorOutput "  pvm lock/sync         - Lock/sync dependencies" "White"
    Write-ColorOutput "  pvm tree              - Show dependency tree" "White"
    Write-ColorOutput "  pvm tool install <p>  - Install a tool (like pipx)" "White"
    Write-ColorOutput "  pvm init/add/run      - Project management" "White"
    Write-ColorOutput "  pvm build/publish     - Build and publish package" "White"
    Write-ColorOutput "  pvm --help            - Show all commands" "White"
    Write-ColorOutput ""
